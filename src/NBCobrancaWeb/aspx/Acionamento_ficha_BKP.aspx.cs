...
namespace NBCobranca.aspx
{
    ...
    public partial class Acionamento_ficha : System.Web.UI.Page
    {
        ...
        {
            Anthem.Manager.AddScriptForClientSideEval("SnapDividas.ToggleExpand();");
            if (this.SnapEndereco.Visible)
                Anthem.Manager.AddScriptForClientSideEval("SnapEndereco.ToggleExpand();");
            if (this.SnapTelefone.Visible)
                Anthem.Manager.AddScriptForClientSideEval("SnapTelefone.ToggleExpand();");
            if (this.SnapEmail.Visible)
                Anthem.Manager.AddScriptForClientSideEval("SnapEmail.ToggleExpand();");
        }
