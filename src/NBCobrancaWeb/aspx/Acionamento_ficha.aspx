...
<%@ Page Language="c#" Codebehind="Acionamento_ficha.aspx.cs" AutoEventWireup="True"
                            ...
                            <tr>
                                <td>
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#a4c955"
                                        style="cursor: hand" onclick="toggleview('linhaEndereco');">
                                        <tr>
                                            <td class="txt_peq">
                    ...
                    <asp:Panel ID="pnSnapTelefones" runat="server" Visible="False">
                        ...
                        <table cellspacing="0" cellpadding="0" width="99%" border="0">
                            <tr>
                                <td>
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#a4c955"
                                        style="cursor: hand" onclick="toggleview('linhaTelefone');">
                                        <tr>
                                            <td class="txt_peq">
                    ...
                    <asp:Panel ID="pnSnapEmails" runat="server" Visible="False">
                        ...
                        <table cellspacing="0" cellpadding="0" width="99%" border="0">
                            <tr>
                                <td>
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#a4c955"
                                        style="cursor: hand" onclick="toggleview('linhaEmail');">
                                        <tr>
                                            <td class="txt_peq">
                    ...
                    <asp:Panel ID="pnlDividas" runat="server" AutoUpdateAfterCallBack="True">
                        ...
                        <table cellspacing="0" cellpadding="0" width="99%" border="0">
                            <tr>
                                <td>
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#a4c955"
                                        style="cursor: hand" onclick="toggleview('linhaDividas');">
                                        <tr>
                                            <td class="txt_peq">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <anthem:Panel ID="pnCartas" runat="server" Visible="False">
                                                ...
                                                <anthem:CheckBox ID="ckbEnviarPorEmail" runat="server" Text="Enviar por email" ToolTip="A carta não será visualizada para impressão, mas somente enviada por email"></anthem:CheckBox>&nbsp;
                                                <input class="botao" id="btnEmitirCarta" style="width: 80px" type="button" value="Emitir Carta"
                                                    name="btnEmitirCarta" runat="server">
                                            </anthem:Panel>
                                            <anthem:Button ID="btnEnviarSMS" runat="server" Width="84px" CssClass="botao" Text="Enviar SMS"
                                                Visible="false" OnClick="btnEnviarSMS_Click" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td valign="top">
                                ...
                                <input type="button" value="Cancelar" style="width: 71px; height: 18px" class="botaoVermelho"
                                    onclick="javascript: window.parent.FecharModal();">
                            </td>
                        </tr>
                    </table>
